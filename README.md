...
For this task, I focused mainly on practical and industry-based sources rather than purely academic ones. This was because my work was closely connected to real production outcomes, including setting up a Steam page,  developing a social media presence, and creating a social facing website. In that context, sources such as video tutorials, official documentation, social media accounts, and existing game websites were more useful than highly theoretical writing, because they gave direct examples of how these features work in practice. They also helped me understand both the technical side of the task and the user-facing side, such as how a page looks, how content is structured, and how audiences engage with it.
...
### Henry Jenkins academic source

Henry Jenkins is a well-known media scholar who writes about digital media, fan culture, and audience participation. His book Fans, Bloggers, and Gamers, published by New York University Press (Jenkins, 2006), is relevant to my work because it explains how audiences interact with media rather than just consume it. This links to my social media, website, resource portal, and Steam page, because these are not only promotional tools, but also ways of connecting with players.

- I looked at Jenkins’ idea of participatory culture
- It helped me think about how social media can build a community
